...
class AMF0DecodingTests: XCTestCase {
    ...
    func testBiggerDictionary() {
        let data = Data(bytes: [AMF0Marker.object.rawValue, /* string length: 1 */ 0x00, 0x01, /* a */ 0x61, AMF0Marker.string.rawValue, /* string length: 1 */ 0x00, 0x01, /* a */ 0x61, /* string length: 1 */ 0x00, 0x01, /* b */ 0x62, AMF0Marker.string.rawValue, /* string length: 1 */ 0x00, 0x01, /* b */ 0x62, /* empty UTF-8 */ 0x00, 0x00, AMF0Marker.objectEnd.rawValue])
        let value = try! decoder.decode([String: String].self, from: data)
